...
I study what makes representations interpretable to humans, how aligning models with human perception reshapes their representations, and what this means for interpretability.
...
<img src="{{ site.url }}{{ site.baseurl }}/images/research/protocol.png" class="research-thumb" loading="lazy">
</div>
